...
package com.hashvoid.crossbinder.servlet;
...
import com.hashvoid.crossbinder.config.jackson.JacksonConfigProvider;
		...
		try {
			...
			if(crossbinder != null) {
				...
				for(String name : corePkgNames) {
					crossbinder.scanner().includePackage(name);
				}
